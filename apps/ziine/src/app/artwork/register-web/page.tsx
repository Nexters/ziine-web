...
import { UndoPopup } from '@/features/artwork-register/components/undo-pop-up';
...
const ArtworkRegisterPage = () => {
  ...
  return (
    <>
      <NavigateBar className={css({ position: 'sticky', top: '0' })} onClick={handleExitClick} />
      <form
        className={css({
          display: 'flex',
      ...
      {isPopUpOpen && <UndoPopup onClickClose={handleClosePopup} onClickCancel={handleLeave} />}
    </>
  );
};
